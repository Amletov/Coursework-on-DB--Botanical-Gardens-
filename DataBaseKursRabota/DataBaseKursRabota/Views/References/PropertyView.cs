namespace DataBaseKursRabota.Views.References
{
    public partial class PropertyView : Form, IPropertyView
    {
        ...
        public string PropertyId { get => idTextBox.Text; set => idTextBox.Text = value; }
        public string Property { get => propertyTextBox.Text; set => propertyTextBox.Text = value; }
        ...
        public void SetPropertyListBindingSource(BindingSource propertyList)
        {
            dataGridView.DataSource = propertyList;
        }
        ...
        private static PropertyView instance;
        public static PropertyView GetInstace(Form parentContainer)
        {
            if (instance == null || instance.IsDisposed)
            {
                instance = new PropertyView();
