...
namespace DataBaseKursRabota.Views
{
    public partial class CityView : Form, ICityView
    {
        ...
        public string CityId { get => idTextBox.Text; set => idTextBox.Text = value; }
        ...
        {
            dataGridView.DataSource = cityList;
        }
        ...
        public static CityView GetInstace(Form parentContainer)
        {
